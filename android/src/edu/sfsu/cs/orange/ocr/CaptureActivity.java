...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ShutterButton.OnShutterButtonListener, TextToSpeech.OnInitListener{
	 ...
	 private TextToSpeech tts;
	    ...
	    public static String speaktest="cars";
	    String speaktest2="cars";
	    String title="";
	    String body="";
  ...
  public static String restext="introduction algorithms";
  ...
  private boolean isTranslationActive=false; // Whether we want to show translations
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
   ...
   //noddy
 //System.out.print(ocrResultTextView.getText());
    //finalOCR=finalOCR+ocrResult.getText();
    
   // System.out.println(finalOCR);
    ...
    TextView datbox = (TextView) findViewById(R.id.datbox);
  //  datbox.setText("");
  //  datbox.append(ocrResult.getText().replaceAll("\n"," "));
    //GANDALF
    
    String tempo=ocrResult.getText().replaceAll("\n", " ");
    restext=tempo;
    tempo=tempo.replaceAll(" ","+");
    datbox.setText("");
    
    String temp2=url+tempo+"book";
   ...
   String holder="";
    try {
        ...
        doc = Jsoup.connect(temp2).get();
        Elements links = doc.select("a");
        for(Element link : links)
        {
        	holder=link.attr("href");
        	 if(holder.contains("books.google"))
        	 {	datbox.setText(holder);           	
        	 //.out.println(holder);
   ...
   //   datbox.setText(ur);
    ...
    Document doc1 = null ;
    try {
		doc1 = Jsoup.connect(holder).get();
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
    String contentText="helicopters";
    Elements elementsHtml = doc1.select("#synopsistext"); 
    ...
    Elements ratinghtml = doc1.select("span.value-title");
    Element rate=ratinghtml.first();
    String rating=rate.attr("title");
    speaktest=contentText;
    datbox.setText(speaktest);
    speaktest2=". It got a rating of "+rating+" stars.";
 ...
 // System.out.print(finalOCR);
  ...
  public void speakOut() {
      ...
      String text =" This needs more Cowbell";

      tts.speak(speaktest+speaktest2, TextToSpeech.QUEUE_FLUSH, null);
 //     tts.speak(speaktest2 , TextToSpeech.QUEUE_FLUSH, null);
//      tv1.setText(title);
  //    tv2.setText(body);
  }
